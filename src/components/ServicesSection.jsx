...
function ServiceCard({ service, cta }) {
  const cardClasses = service.popular
    ...
    : 'p-8 md:p-10 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl hover:bg-white/10 hover:border-white/20 hover:-translate-y-2 active:scale-[1.02] transition-all duration-300'
